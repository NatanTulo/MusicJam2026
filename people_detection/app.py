...
def parse_args(argv=None) -> argparse.Namespace:
    ...
    fsh.add_argument("--excitement-speed", type=float, default=0.45,
                     help="predkosc osoby [1/s] uznana za 'szybko'; siedzaca publika rusza sie"
                          " subtelnie, wiec na sali zwykle trzeba NIZEJ (np. 0.2)")
